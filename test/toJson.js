...
describe('toJson', function() {
  ...
  it('should handle empty objects on buffer edge', function(done) {
    var p = new Parser();
  ...
  it('should understand new list chunky', function(done) {
    var p = new Parser();
    var str1 = 'id={1 2 3} reb';
    var str2 = 'el_faction={id=5}';
